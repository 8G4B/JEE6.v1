...
class Meal(commands.Cog):
    ...
    async def _handle_meal_command(
        ...
        embed = (
            MealEmbed.create_meal_embed(title, menu)
            if title and menu
    ...
    @commands.command(
        name="급식.내일아침", aliases=["급식.내일조식"], description="내일 아침 조회"
    )
    ...
    @commands.command(
        name="급식.내일점심", aliases=["급식.내일중식"], description="내일 점심 조회"
    )
    ...
    @commands.command(
        name="급식.내일저녁", aliases=["급식.내일석식"], description="내일 저녁 조회"
    )
